...
def main():
    ...
    print("""
  ######################################
  # FFR Development Environment Setup #
  ######################################

  This script will create your FFR dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your FFR project folder:
    [Arma 3 installation directory]\\{} => FFR project folder
    P:\\{}                              => FFR project folder
